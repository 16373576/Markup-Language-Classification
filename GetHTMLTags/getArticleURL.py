...
for s in sources:
    if not os.path.isfile("C:/Users/caire/Desktop/OutputData/ClassifyArticlesTags/articleURL/" + s + ".txt"):
                        ...
                        if articleTitle != "PaxHeader":
                            ...
                            with open("C:/NELA2017/NELA2017.tar/NELA2017/" + p.month + "/" + d + "/" + s + "/" +
                                ...
                                try:
                                    ...
                                    # save URL of the json file separately
                                    url = articleData['link']
                                except ValueError:
                                    print("JsonDecodeError for file " + articleTitle)
                            with open("C:/Users/caire/Desktop/OutputData/ClassifyArticlesTags/articleURL/" + s + ".txt",
                                      'a') as newFile:
                                newFile.write(str(url) + "\n")
                            url = ""
